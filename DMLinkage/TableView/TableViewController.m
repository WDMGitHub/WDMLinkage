...
{
    //当前的tableView是RightTableView，RightTableView滚动的方向向上（手势向下滑动），RightTableView是用户拖拽而产生滚动的（主要判断RightTableView用户拖拽而滚动的，还是点击LeftTableView而滚动的）
...
{
    //当前的tableView是RightTableView，RightTableView滚动的方向向下(手势向上滑动)，RightTableView是用户拖拽而产生滚动的（主要判断RightTableView是用户拖拽而滚动的，还是点击LeftTableView而滚动的）
    if ((_rightTableView == tableView) && _isScrollDown && _rightTableView.dragging)
    {
